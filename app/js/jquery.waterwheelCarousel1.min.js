...
(function (a) {
    ...
    a.fn.waterwheelCarousel = function (r) {
        ...
        function j() {
            t = {
                itemsContainer: a(m),
                img: a(m).find('.waterwheel-item'),
                totalItems: a(m).find('.waterwheel-item').length,
            ...
            t.itemsContainer.find('.waterwheel-item').removeClass(c.activeClassName);
            console.log(t.itemsContainer.find('.waterwheel-item'))
        }
        ...
        function h(x) {
            ...
            var v = t.itemsContainer.find('.waterwheel-item'),
                u = 0,
                w = v.length;
            v.each(function () {
        ...
        function d() {
            t.itemsContainer.find('.waterwheel-item').each(function () {
                if (a(this).data("original_width") == undefined || c.forcedImageWidth > 0) {
                    a(this).data("original_widthЫ", a(this).width())
                }
        ...
        function s() {
            var v = t.itemsContainer.find('.waterwheel-item').first();
            t.calculations[0] = {
                distance: 0,
                offset: 0,
                opacity: 1
        ...
        function b() {
            t.items = t.itemsContainer.find('.waterwheel-item');
            ...
            t.itemsContainer.css("position", "relative").find('.waterwheel-item').each(function () {
                var w, v;
                if (c.orientation === "horizontal") {
        ...
        a(this).find('.waterwheel-item').bind("click", function () {
        ...
        a(this).find("a").bind("click", function (u) {
            var v = a(this).find('.waterwheel-item').data("currentPosition") == 0;
        ...
        this.reload = function (v) {
            ...
            j();
            t.itemsContainer.find('.waterwheel-item').hide();
            e();
            h(function () {
                d();
                s();
